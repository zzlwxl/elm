...
;(function (a, b) {
  if (
    ...
    window.location = b
})(navigator.userAgent || navigator.vendor || window.opera, 'https://demo.wangxuelong.vip/html/elm.html')
...
export default {
  ...
  computed: {
    ...mapState(['latitude', 'longitude', 'geohash', 'setCity']),
    obj() {
      return {
  ...
  activated() {
    this.setCity && this.getUserLocation()
  },
}
</script>
