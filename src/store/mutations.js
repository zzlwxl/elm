import { RECORD_ADDRESS,SET_CITY,SET_SHOPID,SET_SUBSUCCESS,SET_CARID,CHOOSE_ADDRESSS,ADD_HISTORYCITY,ADD_ADDRESS,GET_CARALL_LIST,SET_CITYID,DEL_ADDRESS,CLEAR_HISORYADDRESS,GET_ADDRESS,SET_LOGINSTATE,OUT_LOGIN,SET_USERNAME, RECORD_GEOHASH, ADDCAR_LIST ,DELCAR_LIST,DELCARALL_LIST,WRITE_USERINFO,GET_USERINFO} from '@/store/mutation-types.js'
...
export default {
  ...
  // 记录每次点击的商家信息，以便用户首次未登录下单
  [SET_SHOPID](state,value){
    state.shopID=value
  },
